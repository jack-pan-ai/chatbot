...
class Decoder(nn.Module):
    ...
    def forward(self, target, encoder_hidden):
        ...
        decoder_input = torch.ones([batch_size, 1], dtype=torch.int64) * config.num_sequence.SOS
    ...
    def forward_step(self, decoder_input, decoder_hidden):
        ...
        '''
        decoder_input_embeded = self.embedding(decoder_input)  # batch_size, 1, embeddings_dim

        # out [bs, 1, hidden_size]
    ...
    def evaluate(self, encoder_hidden):
        ...
        return indices  # [ max_len+5, batch_size]
